  ...
  return (
    <div className="container mx-auto">
      <div className="flex gap-8 items-center mt-20 relative mx-4">
        <div className="absolute top-0 bottom-0 left-[-1px] w-2 bg-gradient-to-b from-secondary to-primary z-20"></div>
        <div className="absolute top-0 bottom-0 right-[-1px] w-2 bg-gradient-to-b from-primary to-secondary z-20"></div>
        <ScrollShadow
          as="ul"
          className="flex gap-16 overflow-x-auto items-center px-8 snap-x snap-mandatory"
        ...
        >
          ...
          <ScrollShadow
            as="ul"
            className="contents md:flex gap-16 overflow-x-auto items-center px-8 snap-x snap-mandatory"
            orientation="horizontal"
          >
