  ...
  return hasLoadedStats ? (
    <div className="blur-in flex flex-col gap-4 justify-center items-center relative">
      <Button
        ...
        isIconOnly
        aria-label="Like"
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-glass border-[1px] border-accent rounded-full p-6 z-10 opacity-70 text-accent"
        onPress={handleLike}
      >
        <Icon
